...
`,oe=c.memo(c.forwardRef((t,n)=>{const{id:a,user:s,isOnline:r=!0,teacherData:l,favoriteIds:h,delay:i}=t,[p,o]=c.useState(!1),[v,u]=c.useState(!1),[g,w]=c.useState(null),{openModal:b,closeModal:y}=qe(),{tid:m,name:j,surname:C,avatar_url:F}=l,{levels:le,rating:de,reviews:ce,languages:he,conditions:pe,experience:xe}=l,{lesson_info:ue,lessons_done:me,price_per_hour:ge}=l,z=`${j} ${C}`;c.useEffect(()=>{s?Object.values(h).includes(m)&&u(!0):u(!1)},[h,m,s]),c.useEffect(()=>{g&&alert(g)},[g]);const fe=async()=>{if(!s){b(e.jsx(ot,{openModal:b},"authRequired"));return}try{v?(await tt(s.uid,m),u(!1)):(await et(s.uid,m),u(!0))}catch(je){w(je)}};return e.jsxs(Lt,{id:a,custom:i,initial:"initial",animate:"animate",exit:"exit",variants:Ke,layout:"position",ref:n,children:[e.jsx(Tt,{$isFavorite:v,onClick:fe,children:e.jsx(k,{name:"icon-heart",$isFavorite:v})}),e.jsx(Ct,{$isOnline:r,children:e.jsx("img",{src:F,alt:z,width:"96",height:"96"})}),e.jsx(Et,{children:z}),e.jsx(mt,{lessonsDone:me,rating:de,price:ge}),e.jsx(ft,{tid:m,languages:he,lessonInfo:ue,conditions:pe}),e.jsx(Ft,{variants:ze,initial:"initial",animate:p?"animate":"initial",exit:"exit",children:e.jsx(M,{children:p?e.jsxs(e.Fragment,{children:[e.jsx(It,{variants:H,children:xe}),e.jsx(re,{reviews:ce})]}):e.jsx(S,{variant:"underline",onClick:()=>o(!p),children:"Read more"})})}),e.jsx(St,{tid:m,levels:le}),p&&e.jsx(Rt,{onClick:()=>b(e.jsx(dt,{teacherData:l,closeModal:y},"bookLesson")),children:"Book trial lesson"})]})}));oe.displayName="TeacherCard";const Bt=d($.ul)`
  display: flex;
  flex-direction: column;
  gap: 32px;
`,Mt=t=>{const{teachers:n,user:a,favoriteIds:s,initialCount:r,visibleCount:l,isLastPage:h,showMore:i}=t,p=c.useRef(null);c.useEffect(()=>{p.current&&p.current.scrollIntoView({behavior:"smooth",block:"start"})},[n.length]);const o=n.length%r||r,v=n.length-o;return e.jsxs(e.Fragment,{children:[e.jsx(Bt,{children:n.map((u,g)=>{const w=g%r===0,b=g>=r,j=w&&b&&g===v?{ref:p}:{};return e.jsx(oe,{teacherData:u,user:a,favoriteIds:s,delay:(g-(l-r))*.1,...j},u.tid)})}),e.jsx(pt,{isLastPage:h,showMore:i})]})},Z="/language-learning-app/",At=({teachers:t,filters:n,onlyFavorites:a=!1,initialCount:s=4})=>{const[r,l]=c.useState(s),[h,i]=c.useState(!1),[p,o]=c.useState([]),[v,u]=c.useState(!1),[g,w]=st(),{user:b}=te();c.useLayoutEffect(()=>{l(s)},[s,n]),c.useEffect(()=>{if(w||!t.length)return;const m=ct(t,n,g,a);if(m.length)u(!1);else{u(!0),o([]);return}const j=m.slice(0,r);o(j),r>=m.length?i(!0):i(!1)},[t,g,n,w,a,r]);const y=()=>{l(m=>m+s)};return v?g.length===0?e.jsx(G,{src:`${Z}images/empty.svg`,notification:U.isEmpty.noFavTeachers}):e.jsx(G,{src:`${Z}images/filter.svg`,notification:U.isEmpty.noFilterTeachers}):p.length!==0&&e.jsx(Mt,{teachers:p,user:b,favoriteIds:g,initialCount:s,visibleCount:r,isLastPage:h,showMore:y})},Nt=d.div`
  width: 100%;
  padding-top: 32px;
...
`,Vt=({filters:t,setSearchParams:n})=>{const[a,s]=c.useState(!1),[r,l,h,i,p]=at(),o=Qe(`(max-width: ${x.tablet-1}px)`),v=w=>{const b=w.currentTarget.getAttribute("data-name"),y=w.currentTarget.getAttribute("data-value");n(y?m=>(m.set(b,y),m):m=>(m.delete(b),m))},u=()=>{s(w=>!w)},g=()=>{n(new URLSearchParams)};return e.jsxs(Nt,{children:[e.jsxs(M,{children:[e.jsxs(Wt,{children:[((t==null?void 0:t.language)||(t==null?void 0:t.level)||(t==null?void 0:t.price))&&e.jsx($.div,{variants:A,initial:"initial",animate:"animate",exit:"exit",children:e.jsx(S,{variant:"icon",onClick:g,disabled:i,children:e.jsx(k,{name:"icon-filter-x",width:"20px",height:"20px"})})},"reset-filter-btn"),o&&e.jsxs(Dt,{$variant:"icon",$showFilter:a,disabled:i,onClick:u,children:["Filter",e.jsx(k,{name:"icon-chevron-down",width:"20px",height:"20px"})]},"filter-btn")]},"filter-buttons"),(a||!o)&&e.jsxs(Pt,{variants:Ye,initial:"initial",animate:"animate",exit:"exit",children:[e.jsx(P,{id:"language",label:"Languages",value:(t==null?void 0:t.language)??"",options:r,minWidth:"220px",disabled:i,onChange:v}),e.jsx(P,{id:"level",label:"Level of knowledge",value:(t==null?void 0:t.level)??"",options:l,minWidth:"246px",disabled:i,onChange:v}),e.jsx(P,{id:"price",label:"Price",value:(t==null?void 0:t.price)??"",options:h,minWidth:"124px",disabled:i,onChange:v})]},"dropdowns")]}),p&&e.jsxs("p",{children:["Error: ",p.message]})]})},_t=Je`
  0% {
...
`,O=d(L)`
  height: 18px;
  width: 70px;
`,Qt=()=>e.jsxs(zt,{variants:A,initial:"initial",animate:"animate",children:[e.jsxs(V,{width:"220px",children:[e.jsx(O,{}),e.jsx(_,{})]}),e.jsxs(V,{width:"246px",children:[e.jsx(O,{}),e.jsx(_,{})]}),e.jsxs(V,{width:"124px",children:[e.jsx(O,{}),e.jsx(_,{})]})]}),Yt=()=>e.jsxs(e.Fragment,{children:[e.jsx(Qt,{}),Array(4).fill(0).map((t,n)=>e.jsx(Kt,{},n))]}),Zt=({onlyFavorites:t=!1})=>{const[n,a]=c.useState([]),[s,r]=c.useState(null),[l,h]=c.useState(!0),[i,p]=c.useState(null),[o,v]=K();return c.useEffect(()=>{const u=async()=>{try{const g=await ie();a(g)}catch(g){p(g)}finally{h(!1)}};h(!0),u()},[]),c.useEffect(()=>{r({language:o.get("language"),level:o.get("level"),price:o.get("price")})},[o]),i&&alert(i.message),e.jsx(Ze,{children:e.jsx(Xe,{children:l?e.jsx(Yt,{}):e.jsxs(e.Fragment,{children:[e.jsx(Vt,{filters:s,setSearchParams:v}),e.jsx(At,{teachers:n,filters:s,onlyFavorites:t})]})})})};export{Zt as default};
